...
public function Afficher() {
	$this->DébutFormulaire($this->imageMine, $this->nomMine, $this->ID);
?>
		...
		<input type="number" id="prodMax" name="prodMax" value="<?=$this->prodMax?>" min="0" style="width:90px; margin-right:50px">
<?php
	$this->FinFormulaire();
}
...
public function Traiter() {
	try	{
		...
		$requete = $BD->prepare('
			UPDATE mine
			SET nombre = :nombre,	etat = :etat, prod_max = :prod_max
