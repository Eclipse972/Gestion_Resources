...
try	{
	...
	$requete = $BD->prepare('INSERT INTO entrepot (marchandise_ID, joueur_ID, ordre_affichage) VALUES (:marchandise_ID, :IDJoueur, :place)');
	for ($IDJoueur=1; $IDJoueur<3; $IDJoueur++)
		for($marchandise_ID=39; $marchandise_ID<61; $marchandise_ID++)
