...
// si j'utilise usines il ne doit pas avoir de script nommé usine.php sous pein de provoquer une erreur
...
if (isset($T_dossier[$adresse])) {
	$SCRIPT = $T_dossier[$adresse];
	include'Vue/doctype2.html';
}
else {	// erreur
}
